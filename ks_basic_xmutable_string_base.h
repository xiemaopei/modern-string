...
public:
	...
	bool is_exclusive() const {
		return !(this->is_ref_mode() && !_my_ref_ptr()->constantFlag && ks_basic_string_allocator<ELEM>::_peek_refcount32_value(_my_ref_ptr()->alloc_addr(), false) > 1); //note: no need to acquire
	}
